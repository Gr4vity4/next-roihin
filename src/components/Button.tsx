...
const buttonVariants = cva(
  'inline-flex items-center justify-center font-medium font-fciconic transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none transform active:scale-95',
  {
    variants: {
      variant: {
        primary:
