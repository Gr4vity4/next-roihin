...
If design contain dynamic fields, I don't need it. I only need static fields.

Example review rating unnecessary to CRUD, just should be static value like dropdown list:
